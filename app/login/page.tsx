          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-500">AI-Powered Career Companion</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 shadow-sm h-12 text-base cursor-pointer font-medium transition-all duration-200 hover:shadow-md"
                  size="lg"
                >
          ...
          <div className="max-w-lg w-full text-center">
            ...
            <div className="mb-8">
              <div className="relative">
                ...
                {/* Animated Subtitle */}
                <p className="text-base text-gray-600 mb-6 animate-fade-in">
